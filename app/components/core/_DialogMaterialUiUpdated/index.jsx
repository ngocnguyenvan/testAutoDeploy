/**
 * This file is copied from /material-ui/src/dialog.jsx and slightly updated
 * Changes are marked as "Added by Alex B (alex@ylopo.com)"
 */
...
const maxHeightToGoFullscreen = 500; 	// Added by Alex B (alex@ylopo.com)
const maxWidthToGoFullscreen = 667; 	// Added by Alex B (alex@ylopo.com)
...
class DialogInline extends Component {
	...
	positionDialog() {
		...
		const clientWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth; // Added by Alex B (alex@ylopo.com)
		...
		const isFullScreen = clientHeight < maxHeightToGoFullscreen 	|| clientWidth < maxWidthToGoFullscreen; // Added by Alex B (alex@ylopo.com)
		...
		if (autoDetectWindowHeight || autoScrollBodyContent) {
			...
			let maxDialogContentHeight = !isFullScreen ? // Added by Alex B (alex@ylopo.com) 
				(clientHeight - 2 * 64) : clientHeight;
